...
def submit():
    ...
    c.execute("INSERT INTO addresses VALUES (:money, :info, :gender, :birthDate)",
              {
                  'money': entry.get(),
    ...
    c.execute("""UPDATE addresses SET
        ...
        WHERE oid = :oid""",
              {'money': entry_editor.get(),
               ...
               'birthDate': birth_entry_editor.get(),
...
def edit():
    ...
    birth_entry_editor = Entry(background_editor, font=('Impact', 13))
    birth_entry_editor.place(relx=0.4, rely=0.15, relwidth=0.2, relheight=0.05)
    ...
    for record in records:
        ...
        birth_entry_editor.insert(0, record[3])
...
# Birth of pet
birth_label = Label(background, text="Enter your pets birthdate", bg="#DC43D3",
                    font=('Times New Roman CYR', 13, 'bold'))
birth_label.place(relx=0.2, rely=0.2, relwidth=.2, relheight=.05)

birth_entry = Entry(background, font=('Impact', 13))
birth_entry.place(relx=0.4, rely=0.2, relwidth=0.2, relheight=0.05)
...
query_button = Button(background, text="Show Records", bg="#DC43D3", font=('Times New Roman CYR', 13, 'bold'), command=query)
